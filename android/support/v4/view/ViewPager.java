...
public class ViewPager extends ViewGroup {
    ...
    static class C01001 implements Comparator<ItemInfo> {
        C01001() {
        }
    ...
    static class C01012 implements Interpolator {
        C01012() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C02671());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C01001();
        sInterpolator = new C01012();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C01023();
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        int action = ev.getAction() & Utils.FULL_ALPHA;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (this.mAdapter != null) {
            if (this.mAdapter.getCount() != 0) {
                ...
                float x;
                switch (action & Utils.FULL_ALPHA) {
                    case SCROLL_STATE_IDLE /*0*/:
                        this.mScroller.abortAnimation();
                        this.mPopulatePending = DEBUG;
                        populate();
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        ...
        switch (event.getKeyCode()) {
            case C0220R.styleable.Toolbar_navigationContentDescription /*21*/:
                return arrowScroll(17);
            case C0220R.styleable.Toolbar_logoDescription /*22*/:
                return arrowScroll(66);
            case C0220R.styleable.Theme_popupWindowStyle /*61*/:
                if (VERSION.SDK_INT < 11) {
                    return DEBUG;
                }
