...
class AccessibilityManagerCompatIcs {
    ...
    static class C01071 implements AccessibilityStateChangeListener {
        final /* synthetic */ AccessibilityStateChangeListenerBridge val$bridge;

        C01071(AccessibilityStateChangeListenerBridge accessibilityStateChangeListenerBridge) {
