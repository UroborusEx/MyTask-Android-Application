...
class SearchViewCompatHoneycomb {
    ...
    static class C01231 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C01231(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C01242 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C01242(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
