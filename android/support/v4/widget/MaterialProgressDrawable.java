...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    class C01191 extends Animation {
    ...
    class C01202 implements AnimationListener {
        final /* synthetic */ Ring val$ring;
    ...
    class C01213 implements Callback {
        C01213() {
        }
    ...
    private static class Ring {
        ...
        public void draw(Canvas c, Rect bounds) {
            ...
            if (this.mAlpha < Utils.FULL_ALPHA) {
    ...
    private int evaluateColorChange(float fraction, int startValue, int endValue) {
        ...
        int startA = (startInt >> 24) & Utils.FULL_ALPHA;
        int startR = (startInt >> 16) & Utils.FULL_ALPHA;
        int startG = (startInt >> 8) & Utils.FULL_ALPHA;
        int startB = startInt & Utils.FULL_ALPHA;
        int endInt = Integer.valueOf(endValue).intValue();
        return ((((((int) (((float) (((endInt >> 24) & Utils.FULL_ALPHA) - startA)) * fraction)) + startA) << 24) | ((((int) (((float) (((endInt >> 16) & Utils.FULL_ALPHA) - startR)) * fraction)) + startR) << 16)) | ((((int) (((float) (((endInt >> 8) & Utils.FULL_ALPHA) - startG)) * fraction)) + startG) << 8)) | (((int) (((float) ((endInt & Utils.FULL_ALPHA) - startB)) * fraction)) + startB);
    }
    ...
    private void setupAnimators() {
        Ring ring = this.mRing;
        Animation animation = new C01191(ring);
        animation.setRepeatCount(-1);
        animation.setRepeatMode(DEFAULT);
        animation.setInterpolator(LINEAR_INTERPOLATOR);
        animation.setAnimationListener(new C01202(ring));
