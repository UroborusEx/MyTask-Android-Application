    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode != 1073741824) {
            ...
            if (!isInEditMode()) {
                ...
                heightMode = LinearLayoutManager.INVALID_OFFSET;
                heightSize = 300;
            }
        }
        int layoutHeight = 0;
        ...
        for (i = 0; i < childCount; i++) {
            ...
            if (child.getVisibility() == 8) {
                ...
                i2 = lp.width;
                if (r0 == -2) {
                    childWidthSpec = MeasureSpec.makeMeasureSpec(widthAvailable - horizontalMargin, LinearLayoutManager.INVALID_OFFSET);
                } else {
                    i2 = lp.width;
                    if (r0 == -1) {
                ...
                i2 = lp.height;
                if (r0 == -2) {
                    childHeightSpec = MeasureSpec.makeMeasureSpec(maxLayoutHeight, LinearLayoutManager.INVALID_OFFSET);
                } else {
                    i2 = lp.height;
                    if (r0 == -1) {
