...
class FragmentTransitionCompat21 {
    ...
    static class C00321 extends EpicenterCallback {
    ...
    static class C00332 implements OnPreDrawListener {
        ...
        C00332(View view, Transition transition, View view2, ViewRetriever viewRetriever, Map map, Map map2, ArrayList arrayList) {
    ...
    static class C00343 extends EpicenterCallback {
        private Rect mEpicenter;
        final /* synthetic */ EpicenterView val$epicenterView;

        C00343(EpicenterView epicenterView) {
    ...
    static class C00354 implements OnPreDrawListener {
        final /* synthetic */ Transition val$enterTransition;
        final /* synthetic */ ArrayList val$enteringViews;
        ...
        C00354(View view, Transition transition, ArrayList arrayList, Transition transition2, ArrayList arrayList2, Transition transition3, ArrayList arrayList3, Map map, ArrayList arrayList4, Transition transition4, View view2) {
    ...
    public static void setEpicenter(Object transitionObject, View view) {
        ((Transition) transitionObject).setEpicenterCallback(new C00321(getBoundsOnScreen(view)));
    }
    ...
    public static void addTransitionTargets(Object enterTransitionObject, Object sharedElementTransitionObject, View container, ViewRetriever inFragment, View nonExistentView, EpicenterView epicenterView, Map<String, String> nameOverrides, ArrayList<View> enteringViews, Map<String, View> namedViews, Map<String, View> renamedViews, ArrayList<View> sharedElementTargets) {
        if (enterTransitionObject != null || sharedElementTransitionObject != null) {
            ...
            if (inFragment != null) {
                container.getViewTreeObserver().addOnPreDrawListener(new C00332(container, enterTransition, nonExistentView, inFragment, nameOverrides, renamedViews, enteringViews));
            }
    ...
    private static void setSharedElementEpicenter(Transition transition, EpicenterView epicenterView) {
        if (transition != null) {
            transition.setEpicenterCallback(new C00343(epicenterView));
        }
    }
    ...
    public static void cleanupTransitions(View sceneRoot, View nonExistentView, Object enterTransitionObject, ArrayList<View> enteringViews, Object exitTransitionObject, ArrayList<View> exitingViews, Object sharedElementTransitionObject, ArrayList<View> sharedElementTargets, Object overallTransitionObject, ArrayList<View> hiddenViews, Map<String, View> renamedViews) {
        ...
        if (overallTransition != null) {
            sceneRoot.getViewTreeObserver().addOnPreDrawListener(new C00354(sceneRoot, enterTransition, enteringViews, exitTransition, exitingViews, sharedElementTransition, sharedElementTargets, renamedViews, hiddenViews, overallTransition, nonExistentView));
        }
    }
