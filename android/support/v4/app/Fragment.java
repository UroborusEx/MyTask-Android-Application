...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    public static class SavedState implements Parcelable {
        ...
        static class C00281 implements Creator<SavedState> {
            C00281() {
            }
    ...
    class C02481 extends FragmentContainer {
        C02481() {
        }
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachController(this.mHost, new C02481(), this);
    }
