...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class C00552 implements Runnable {
    ...
    class C02553 extends Result<List<MediaItem>> {
        final /* synthetic */ ConnectionRecord val$connection;
        final /* synthetic */ String val$parentId;

        C02553(Object x0, String str, ConnectionRecord connectionRecord) {
            this.val$parentId = str;
    ...
    class C02564 extends Result<MediaItem> {
        final /* synthetic */ ResultReceiver val$receiver;

        C02564(Object x0, ResultReceiver resultReceiver) {
    ...
    private class ServiceBinder extends Stub {
        ...
        class C00561 implements Runnable {
            ...
            C00561(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks, String str, Bundle bundle, int i) {
        ...
        class C00572 implements Runnable {
            ...
            C00572(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks) {
                this.val$callbacks = iMediaBrowserServiceCompatCallbacks;
            }
        ...
        class C00583 implements Runnable {
            ...
            C00583(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks, String str) {
                this.val$callbacks = iMediaBrowserServiceCompatCallbacks;
                this.val$id = str;
            }
        ...
        class C00594 implements Runnable {
            final /* synthetic */ IMediaBrowserServiceCompatCallbacks val$callbacks;
            final /* synthetic */ String val$id;

            C00594(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks, String str) {
                this.val$callbacks = iMediaBrowserServiceCompatCallbacks;
                this.val$id = str;
            }
        ...
        class C00605 implements Runnable {
            ...
            C00605(String str, ResultReceiver resultReceiver) {
        ...
        public void connect(String pkg, Bundle rootHints, IMediaBrowserServiceCompatCallbacks callbacks) {
            ...
            if (MediaBrowserServiceCompat.this.isValidPackage(pkg, uid)) {
                MediaBrowserServiceCompat.this.mHandler.post(new C00561(callbacks, pkg, rootHints, uid));
                return;
            }
        ...
        public void disconnect(IMediaBrowserServiceCompatCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00572(callbacks));
        }

        public void addSubscription(String id, IMediaBrowserServiceCompatCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00583(callbacks, id));
        }

        public void removeSubscription(String id, IMediaBrowserServiceCompatCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00594(callbacks, id));
        }

        public void getMediaItem(String mediaId, ResultReceiver receiver) {
            if (!TextUtils.isEmpty(mediaId) && receiver != null) {
                MediaBrowserServiceCompat.this.mHandler.post(new C00605(mediaId, receiver));
            }
        }
    }
    ...
    public void setSessionToken(Token token) {
        if (token == null) {
            ...
            this.mSession = token;
            this.mHandler.post(new C00541(token));
        }
    }
    ...
    public void notifyChildrenChanged(@NonNull String parentId) {
        ...
        this.mHandler.post(new C00552(parentId));
    }
    ...
    private void performLoadChildren(String parentId, ConnectionRecord connection) {
        Result<List<MediaItem>> result = new C02553(parentId, parentId, connection);
    ...
    private void performLoadItem(String itemId, ResultReceiver receiver) {
        Result<MediaItem> result = new C02564(itemId, receiver);
