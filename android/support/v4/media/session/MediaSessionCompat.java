...
public class MediaSessionCompat {
    ...
    public static final class QueueItem implements Parcelable {
        ...
        static class C00741 implements Creator<QueueItem> {
            C00741() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        ...
        static class C00751 implements Creator<ResultReceiverWrapper> {
            C00751() {
            }
    ...
    public static final class Token implements Parcelable {
        ...
        static class C00761 implements Creator<Token> {
            C00761() {
            }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
            ...
            private void onMediaButtonEvent(KeyEvent ke) {
                ...
                if (ke != null && ke.getAction() == 0) {
                    ...
                    switch (ke.getKeyCode()) {
                        case C0220R.styleable.Theme_panelMenuListWidth /*79*/:
                        case C0220R.styleable.Theme_colorControlNormal /*85*/:
                            boolean isPlaying;
                        ...
                        case C0220R.styleable.Theme_colorControlActivated /*86*/:
                            if ((1 & validActions) != 0) {
                                MediaSessionImplBase.this.mCallback.onStop();
                            }
                        case C0220R.styleable.Theme_colorControlHighlight /*87*/:
                            if ((32 & validActions) != 0) {
                                MediaSessionImplBase.this.mCallback.onSkipToNext();
                            }
                        case C0220R.styleable.Theme_colorButtonNormal /*88*/:
                            if ((16 & validActions) != 0) {
                                MediaSessionImplBase.this.mCallback.onSkipToPrevious();
                            }
                        case C0220R.styleable.Theme_colorSwitchThumbNormal /*89*/:
                            if ((8 & validActions) != 0) {
                                MediaSessionImplBase.this.mCallback.onRewind();
                            }
                        case C0220R.styleable.Theme_controlBackground /*90*/:
        ...
        class C02591 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C02591() {
            }
        ...
        public MediaSessionImplBase(Context context, String tag, ComponentName mbrComponent, PendingIntent mbr) {
            ...
            this.mVolumeCallback = new C02591();
        ...
        public void setCallback(Callback callback, Handler handler) {
            if (callback != this.mCallback) {
                if (callback == null || VERSION.SDK_INT < 18) {
                    ...
                    Callback cb14 = new C02602(callback);
                    if (VERSION.SDK_INT >= 18) {
    ...
    public MediaSessionCompat(Context context, String tag, ComponentName mediaButtonEventReceiver, PendingIntent mbrIntent) {
        ...
        if (context == null) {
            ...
            if (mediaButtonEventReceiver == null) {
                ...
                if (resolveInfos.size() == FLAG_HANDLES_MEDIA_BUTTONS) {
                ...
                } else if (resolveInfos.size() > FLAG_HANDLES_MEDIA_BUTTONS) {
