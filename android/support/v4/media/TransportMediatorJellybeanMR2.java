...
class TransportMediatorJellybeanMR2 {
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
        this.mWindowAttachListener = new C00651();
        this.mWindowFocusListener = new C00662();
        this.mMediaButtonReceiver = new C00673();
        this.mAudioFocusChangeListener = new C00684();
        this.mGetPlaybackPositionListener = new C00695();
        this.mPlaybackPositionUpdateListener = new C00706();
        this.mPlayState = 0;
