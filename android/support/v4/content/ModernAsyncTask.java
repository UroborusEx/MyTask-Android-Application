...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static class C00411 implements ThreadFactory {
    ...
    class C00423 extends FutureTask<Result> {
        C00423(Callable x0) {
            super(x0);
        }
    ...
    class C02522 extends WorkerRunnable<Params, Result> {
        C02522() {
            super();
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C02522();
        this.mFuture = new C00423(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C00434.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
