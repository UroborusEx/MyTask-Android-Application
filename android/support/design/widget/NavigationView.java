...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C02351 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02351() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C02351());
        }
    }

    /* renamed from: android.support.design.widget.NavigationView.1 */
    class C02341 implements Callback {
        C02341() {
        }
    ...
    public NavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenu.setCallback(new C02341());
