...
public class SwipeDismissBehavior<V extends View> extends Behavior<V> {
    ...
    class C02401 extends Callback {
        ...
        public void onViewPositionChanged(View child, int left, int top, int dx, int dy) {
            ...
            if (((float) left) <= startAlphaDistance) {
                ...
                ViewCompat.setAlpha(child, SwipeDismissBehavior.clamp((float) SwipeDismissBehavior.DEFAULT_ALPHA_START_DISTANCE, 1.0f - SwipeDismissBehavior.fraction(startAlphaDistance, endAlphaDistance, (float) left), 1.0f));
            }
        }
    }
    ...
    public void setDragDismissDistance(float distance) {
        this.mDragDismissThreshold = clamp((float) DEFAULT_ALPHA_START_DISTANCE, distance, 1.0f);
    }

    public void setStartAlphaSwipeDistance(float fraction) {
        this.mAlphaStartSwipeDistance = clamp((float) DEFAULT_ALPHA_START_DISTANCE, fraction, 1.0f);
    }

    public void setEndAlphaSwipeDistance(float fraction) {
        this.mAlphaEndSwipeDistance = clamp((float) DEFAULT_ALPHA_START_DISTANCE, fraction, 1.0f);
    }
