...
public class TextInputLayout extends LinearLayout {
    ...
    class C00131 implements TextWatcher {
        C00131() {
        }
    ...
    class C02434 implements AnimatorUpdateListener {
        C02434() {
        }
    ...
    class C03092 extends ViewPropertyAnimatorListenerAdapter {
        C03092() {
        }
    ...
    class C03103 extends ViewPropertyAnimatorListenerAdapter {
        C03103() {
        }
    ...
    private void setEditText(EditText editText) {
        ...
        this.mEditText.addTextChangedListener(new C00131());
    ...
    public void setError(@Nullable CharSequence error) {
        ...
        if (!TextUtils.isEmpty(error)) {
            ...
            ViewCompat.animate(this.mErrorView).alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR).setListener(new C03092()).start();
            this.mErrorShown = true;
            updateEditTextBackground();
            updateLabelVisibility(true);
        } else if (this.mErrorView.getVisibility() == 0) {
            ViewCompat.animate(this.mErrorView).alpha(0.0f).setDuration(200).setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR).setListener(new C03103()).start();
            this.mErrorShown = false;
            updateEditTextBackground();
        }
    }
    ...
    private void animateToExpansionFraction(float target) {
        if (this.mCollapsingTextHelper.getExpansionFraction() != target) {
            if (this.mAnimator == null) {
                ...
                this.mAnimator.setUpdateListener(new C02434());
            }
