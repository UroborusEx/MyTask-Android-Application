...
public class AppBarLayout extends LinearLayout {
    ...
    class C02231 implements OnApplyWindowInsetsListener {
        C02231() {
        }
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        protected static class SavedState extends BaseSavedState {
            ...
            static class C02251 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C02251() {
                }
            ...
            static {
                CREATOR = ParcelableCompat.newCreator(new C02251());
            }
        }

        /* renamed from: android.support.design.widget.AppBarLayout.Behavior.1 */
        class C02241 implements AnimatorUpdateListener {
            final /* synthetic */ AppBarLayout val$child;
            final /* synthetic */ CoordinatorLayout val$coordinatorLayout;

            C02241(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout) {
        ...
        private void animateOffsetTo(CoordinatorLayout coordinatorLayout, AppBarLayout child, int offset) {
            ...
            if (currentOffset != offset) {
                if (this.mAnimator == null) {
                    ...
                    this.mAnimator.setUpdateListener(new C02241(coordinatorLayout, child));
                } else {
                    this.mAnimator.cancel();
                }
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, AppBarLayout abl) {
            ...
            if (offsetChild != null) {
                ...
                if ((lp.getScrollFlags() & 17) == 17) {
                    ...
                    if ((lp.getScrollFlags() & AppBarLayout.PENDING_ACTION_COLLAPSED) == AppBarLayout.PENDING_ACTION_COLLAPSED) {
                        childBottom += ViewCompat.getMinimumHeight(offsetChild);
                    }
                    if (offset < (childBottom + childTop) / AppBarLayout.PENDING_ACTION_COLLAPSED) {
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attrs) {
            ...
            this.mOverlayTop = a.getDimensionPixelSize(C0000R.styleable.ScrollingViewBehavior_Params_behavior_overlapTop, 0);
            a.recycle();
        }
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02231());
    }
