...
public class TabLayout extends HorizontalScrollView {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        class C02421 implements AnimatorUpdateListener {
            ...
            C02421(int i, int i2, int i3, int i4) {
        ...
        class C03082 extends AnimatorListenerAdapter {
        ...
        void animateIndicatorToPosition(int position, int duration) {
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ...
                animator.setUpdateListener(new C02421(startLeft, targetLeft, startRight, targetRight));
                animator.setListener(new C03082(position));
                animator.start();
    ...
    class C02412 implements AnimatorUpdateListener {
        C02412() {
        }
        ...
        if (newPosition != INVALID_WIDTH) {
            ...
            if (startScrollX != targetScrollX) {
                if (this.mScrollAnimator == null) {
                    ...
                    this.mScrollAnimator.setUpdateListener(new C02412());
                }
