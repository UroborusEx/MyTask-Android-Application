...
class ValueAnimatorCompat {
    ...
    class C02441 implements AnimatorUpdateListenerProxy {
        final /* synthetic */ AnimatorUpdateListener val$updateListener;

        C02441(AnimatorUpdateListener animatorUpdateListener) {
    ...
    class C02452 implements AnimatorListenerProxy {
        final /* synthetic */ AnimatorListener val$listener;

        C02452(AnimatorListener animatorListener) {
    ...
    public void setUpdateListener(AnimatorUpdateListener updateListener) {
        if (updateListener != null) {
            this.mImpl.setUpdateListener(new C02441(updateListener));
        } else {
    ...
    public void setListener(AnimatorListener listener) {
        if (listener != null) {
            this.mImpl.setListener(new C02452(listener));
        } else {
