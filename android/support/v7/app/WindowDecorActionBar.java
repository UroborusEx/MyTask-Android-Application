...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C02793 implements ViewPropertyAnimatorUpdateListener {
        C02793() {
        }
    ...
    class C03141 extends ViewPropertyAnimatorListenerAdapter {
        C03141() {
        }
    ...
    class C03152 extends ViewPropertyAnimatorListenerAdapter {
        C03152() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C03141();
        this.mShowListener = new C03152();
        this.mUpdateListener = new C02793();
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0152R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0152R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0152R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0152R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0152R.styleable.ActionBar, C0152R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0152R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0152R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0152R.attr.actionBarWidgetTheme, outValue, true);
