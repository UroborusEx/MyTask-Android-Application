...
class AlertController {
    ...
    class C01404 implements OnScrollListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C01404(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    class C01415 implements Runnable {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C01415(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    public static class AlertParams {
        ...
        class C01421 extends ArrayAdapter<CharSequence> {
            final /* synthetic */ ListView val$listView;

            C01421(Context x0, int x1, int x2, CharSequence[] x3, ListView listView) {
        ...
        class C01432 extends CursorAdapter {
            private final int mIsCheckedIndex;
            private final int mLabelIndex;
            final /* synthetic */ AlertController val$dialog;
            final /* synthetic */ ListView val$listView;

            C01432(Context x0, Cursor x1, boolean x2, ListView listView, AlertController alertController) {
                this.val$listView = listView;
        ...
        class C01443 implements OnItemClickListener {
            final /* synthetic */ AlertController val$dialog;

            C01443(AlertController alertController) {
                this.val$dialog = alertController;
            }
        ...
        class C01454 implements OnItemClickListener {
            final /* synthetic */ AlertController val$dialog;
            final /* synthetic */ ListView val$listView;

            C01454(ListView listView, AlertController alertController) {
                this.val$listView = listView;
                this.val$dialog = alertController;
            }
        ...
        private void createListView(AlertController dialog) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                adapter = new C01421(this.mContext, dialog.mMultiChoiceItemLayout, 16908308, this.mItems, listView);
            } else {
                ListAdapter c01432 = new C01432(this.mContext, this.mCursor, false, listView, dialog);
            }
            ...
            if (this.mOnClickListener != null) {
                listView.setOnItemClickListener(new C01443(dialog));
            } else if (this.mOnCheckboxClickListener != null) {
                listView.setOnItemClickListener(new C01454(listView, dialog));
            }
    ...
    class C02732 implements OnScrollChangeListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C02732(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        this.mButtonHandler = new C01381();
        this.mContext = context;
        this.mDialog = di;
        this.mWindow = window;
        this.mHandler = new ButtonHandler(di);
        TypedArray a = context.obtainStyledAttributes(null, C0152R.styleable.AlertDialog, C0152R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0152R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0152R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0152R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0152R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0152R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0152R.styleable.AlertDialog_listItemLayout, 0);
        a.recycle();
    }
    ...
    private void setupView() {
        View parentPanel = this.mWindow.findViewById(C0152R.id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0152R.id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0152R.id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0152R.id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0152R.id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0152R.id.topPanel);
        View customContentPanel = customPanel.findViewById(C0152R.id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0152R.id.buttonPanel);
        ...
        if (!(hasButtonPanel || contentPanel == null)) {
            View spacer = contentPanel.findViewById(C0152R.id.textSpacerNoButtons);
            if (spacer != null) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0152R.id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0152R.id.scrollIndicatorDown);
        ...
        if (indicatorUp != null || indicatorDown != null) {
            ...
            if (this.mMessage != null) {
                this.mScrollView.setOnScrollChangeListener(new C02732(top, bottom));
                this.mScrollView.post(new C01393(top, bottom));
            } else if (this.mListView != null) {
                this.mListView.setOnScrollListener(new C01404(top, bottom));
                this.mListView.post(new C01415(top, bottom));
            } else {
                if (top != null) {
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0152R.id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        ...
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0152R.id.title_template).setVisibility(8);
            return;
        }
        ...
        if (hasTextTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0152R.id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0152R.id.scrollView);
