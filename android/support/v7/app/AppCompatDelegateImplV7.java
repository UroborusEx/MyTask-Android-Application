...
import android.support.v7.appcompat.C0152R;
...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    class C01471 implements Runnable {
        ...
        public void run() {
            ...
            if ((AppCompatDelegateImplV7.this.mInvalidatePanelMenuFeatures & ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT) != 0) {
                AppCompatDelegateImplV7.this.doInvalidatePanelMenu(C0220R.styleable.Theme_spinnerStyle);
            }
    ...
    class C01485 implements Runnable {

        /* renamed from: android.support.v7.app.AppCompatDelegateImplV7.5.1 */
        class C03111 extends ViewPropertyAnimatorListenerAdapter {
            C03111() {
            }
        ...
        public void run() {
            ...
            AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C03111());
        }
    }
    ...
    private static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            ...
            static class C02771 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C02771() {
                }
            ...
            static {
                CREATOR = ParcelableCompat.newCreator(new C02771());
            }
        }
        ...
        void setStyle(Context context) {
            ...
            widgetTheme.resolveAttribute(C0152R.attr.actionBarPopupTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            }
            widgetTheme.resolveAttribute(C0152R.attr.panelMenuListTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            } else {
                widgetTheme.applyStyle(C0152R.style.Theme_AppCompat_CompactMenu, true);
            }
            Context context2 = new ContextThemeWrapper(context, 0);
            context2.getTheme().setTo(widgetTheme);
            this.listPresenterContext = context2;
            TypedArray a = context2.obtainStyledAttributes(C0152R.styleable.Theme);
            this.background = a.getResourceId(C0152R.styleable.Theme_panelBackground, 0);
            this.windowAnimations = a.getResourceId(C0152R.styleable.Theme_android_windowAnimationStyle, 0);
            a.recycle();
        }
        ...
        MenuView getListMenuView(MenuPresenter.Callback cb) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0152R.layout.abc_list_menu_item_layout);
    ...
    class C02742 implements OnApplyWindowInsetsListener {
        C02742() {
        }
    ...
    class C02753 implements OnFitSystemWindowsListener {
        C02753() {
        }
    ...
    class C02764 implements OnAttachListener {
        C02764() {
        }
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(MenuBuilder subMenu) {
            ...
            if (cb != null) {
                cb.onMenuOpened(C0220R.styleable.Theme_spinnerStyle, subMenu);
            }
            return true;
        }
    ...
    class ActionModeCallbackWrapperV7 implements ActionMode.Callback {
        ...
        class C03131 extends ViewPropertyAnimatorListenerAdapter {
            C03131() {
            }
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV7.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C03131());
            }
    ...
    class C03126 extends ViewPropertyAnimatorListenerAdapter {
        C03126() {
        }
    ...
    AppCompatDelegateImplV7(Context context, Window window, AppCompatCallback callback) {
        ...
        this.mFadeAnim = null;
        this.mInvalidatePanelMenuRunnable = new C01471();
    }
        ...
        if (!this.mSubDecorInstalled) {
            ...
            if (!isDestroyed()) {
                if (st == null || st.menu == null) {
                    invalidatePanelMenu(C0220R.styleable.Theme_spinnerStyle);
                }
            }
        }
    }
    ...
    private ViewGroup createSubDecor() {
        TypedArray a = this.mContext.obtainStyledAttributes(C0152R.styleable.Theme);
        if (a.hasValue(C0152R.styleable.Theme_windowActionBar)) {
            if (a.getBoolean(C0152R.styleable.Theme_windowNoTitle, false)) {
                requestWindowFeature(1);
            } else if (a.getBoolean(C0152R.styleable.Theme_windowActionBar, false)) {
                requestWindowFeature(C0220R.styleable.Theme_spinnerStyle);
            }
            if (a.getBoolean(C0152R.styleable.Theme_windowActionBarOverlay, false)) {
                requestWindowFeature(C0220R.styleable.Theme_switchStyle);
            }
            if (a.getBoolean(C0152R.styleable.Theme_windowActionModeOverlay, false)) {
                requestWindowFeature(10);
            }
            this.mIsFloating = a.getBoolean(C0152R.styleable.Theme_android_windowIsFloating, false);
            a.recycle();
            LayoutInflater inflater = LayoutInflater.from(this.mContext);
            ViewGroup subDecor = null;
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    subDecor = (ViewGroup) inflater.inflate(C0152R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    subDecor = (ViewGroup) inflater.inflate(C0152R.layout.abc_screen_simple, null);
                }
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(subDecor, new C02742());
                } else {
                    ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new C02753());
                }
            } else if (this.mIsFloating) {
                subDecor = (ViewGroup) inflater.inflate(C0152R.layout.abc_dialog_title_material, null);
                this.mOverlayActionBar = false;
                this.mHasActionBar = false;
            } else if (this.mHasActionBar) {
                Context themedContext;
                TypedValue outValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(C0152R.attr.actionBarTheme, outValue, true);
                if (outValue.resourceId != 0) {
                    themedContext = new ContextThemeWrapper(this.mContext, outValue.resourceId);
                } else {
                    themedContext = this.mContext;
                }
                subDecor = (ViewGroup) LayoutInflater.from(themedContext).inflate(C0152R.layout.abc_screen_toolbar, null);
                this.mDecorContentParent = (DecorContentParent) subDecor.findViewById(C0152R.id.decor_content_parent);
                this.mDecorContentParent.setWindowCallback(getWindowCallback());
                if (this.mOverlayActionBar) {
                    this.mDecorContentParent.initFeature(C0220R.styleable.Theme_switchStyle);
                }
            ...
            if (this.mDecorContentParent == null) {
                this.mTitleView = (TextView) subDecor.findViewById(C0152R.id.title);
            }
            ViewUtils.makeOptionalFitsSystemWindows(subDecor);
            ViewGroup decorContent = (ViewGroup) this.mWindow.findViewById(16908290);
            ContentFrameLayout abcContent = (ContentFrameLayout) subDecor.findViewById(C0152R.id.action_bar_activity_content);
            ...
            abcContent.setAttachListener(new C02764());
            return subDecor;
        }
        a.recycle();
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(C0152R.styleable.Theme);
        a.getValue(C0152R.styleable.Theme_windowMinWidthMajor, cfl.getMinWidthMajor());
        a.getValue(C0152R.styleable.Theme_windowMinWidthMinor, cfl.getMinWidthMinor());
        if (a.hasValue(C0152R.styleable.Theme_windowFixedWidthMajor)) {
            a.getValue(C0152R.styleable.Theme_windowFixedWidthMajor, cfl.getFixedWidthMajor());
        }
        if (a.hasValue(C0152R.styleable.Theme_windowFixedWidthMinor)) {
            a.getValue(C0152R.styleable.Theme_windowFixedWidthMinor, cfl.getFixedWidthMinor());
        }
        if (a.hasValue(C0152R.styleable.Theme_windowFixedHeightMajor)) {
            a.getValue(C0152R.styleable.Theme_windowFixedHeightMajor, cfl.getFixedHeightMajor());
        }
        if (a.hasValue(C0152R.styleable.Theme_windowFixedHeightMinor)) {
            a.getValue(C0152R.styleable.Theme_windowFixedHeightMinor, cfl.getFixedHeightMinor());
        }
        a.recycle();
        cfl.requestLayout();
    }
    ...
    public boolean requestWindowFeature(int featureId) {
        ...
        if (this.mWindowNoTitle && featureId == C0220R.styleable.Theme_spinnerStyle) {
            return false;
        }
        ...
        switch (featureId) {
            ...
            case C0220R.styleable.Toolbar_titleTextAppearance /*10*/:
                ...
                return true;
            case C0220R.styleable.Theme_spinnerStyle /*108*/:
                throwFeatureRequestIfSubDecorInstalled();
                this.mHasActionBar = true;
                return true;
            case C0220R.styleable.Theme_switchStyle /*109*/:
                throwFeatureRequestIfSubDecorInstalled();
    ...
    void onPanelClosed(int featureId, Menu menu) {
        if (featureId == C0220R.styleable.Theme_spinnerStyle) {
            ActionBar ab = getSupportActionBar();
            if (ab != null) {
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    baseTheme.resolveAttribute(C0152R.attr.actionBarTheme, outValue, true);
                    if (outValue.resourceId != 0) {
                    ...
                    this.mActionModePopup = new PopupWindow(actionBarContext, null, C0152R.attr.actionModePopupWindowStyle);
                    PopupWindowCompat.setWindowLayoutType(this.mActionModePopup, 2);
                    this.mActionModePopup.setContentView(this.mActionModeView);
                    this.mActionModePopup.setWidth(-1);
                    actionBarContext.getTheme().resolveAttribute(C0152R.attr.actionBarSize, outValue, true);
                    ...
                    this.mShowActionModePopup = new C01485();
                } else {
                    ViewStubCompat stub = (ViewStubCompat) this.mSubDecor.findViewById(C0152R.id.action_mode_bar_stub);
                    if (stub != null) {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    this.mFadeAnim.setListener(new C03126());
                    if (this.mActionModePopup != null) {
    ...
    boolean onKeyUp(int keyCode, KeyEvent event) {
        switch (keyCode) {
            case ItemTouchHelper.LEFT /*4*/:
                ...
                break;
            case C0220R.styleable.Theme_colorPrimary /*82*/:
        ...
        if (!st.isOpen && !isDestroyed()) {
            ...
            if (cb == null || cb.onMenuOpened(st.featureId, st.menu)) {
                ...
                if (wm != null && preparePanel(st, event)) {
                    ...
                    st.isHandled = false;
                    WindowManager.LayoutParams lp2 = new WindowManager.LayoutParams(width, -2, st.f2x, st.f3y, 1002, 8519680, -3);
    ...
    private void reopenMenu(MenuBuilder menu, boolean toggleMenuMode) {
        ...
        if (this.mDecorContentParent.isOverflowMenuShowing() && toggleMenuMode) {
            ...
            if (!isDestroyed()) {
                cb.onPanelClosed(C0220R.styleable.Theme_spinnerStyle, getPanelState(0, true).menu);
            }
            ...
            if (st.menu != null && !st.refreshMenuContent && cb.onPreparePanel(0, st.createdPanelView, st.menu)) {
                cb.onMenuOpened(C0220R.styleable.Theme_spinnerStyle, st.menu);
    ...
    private boolean initializePanelMenu(PanelFeatureState st) {
        Context context = this.mContext;
        if ((st.featureId == 0 || st.featureId == C0220R.styleable.Theme_spinnerStyle) && this.mDecorContentParent != null) {
            TypedValue outValue = new TypedValue();
            ...
            if (outValue.resourceId != 0) {
                ...
                widgetTheme.applyStyle(outValue.resourceId, true);
                widgetTheme.resolveAttribute(C0152R.attr.actionBarWidgetTheme, outValue, true);
            } else {
                baseTheme.resolveAttribute(C0152R.attr.actionBarWidgetTheme, outValue, true);
            }
            if (outValue.resourceId != 0) {
                if (widgetTheme == null) {
                    widgetTheme = context.getResources().newTheme();
    ...
    private boolean preparePanel(PanelFeatureState st, KeyEvent event) {
        ...
        if (st.featureId == 0 || st.featureId == C0220R.styleable.Theme_spinnerStyle) {
    ...
    private void checkCloseActionMenu(MenuBuilder menu) {
        if (!this.mClosingActionMenu) {
            ...
            Window.Callback cb = getWindowCallback();
            if (!(cb == null || isDestroyed())) {
                cb.onPanelClosed(C0220R.styleable.Theme_spinnerStyle, menu);
            }
    ...
    private void doInvalidatePanelMenu(int featureId) {
        ...
        st.refreshDecorView = true;
        if ((featureId == C0220R.styleable.Theme_spinnerStyle || featureId == 0) && this.mDecorContentParent != null) {
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (mlp.topMargin != newMargin) {
                    ...
                    if (this.mStatusGuard == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mContext.getResources().getColor(C0152R.color.abc_input_method_navigation_guard));
    ...
    private int sanitizeWindowFeatureId(int featureId) {
        if (featureId == 8) {
            ...
            return C0220R.styleable.Theme_spinnerStyle;
        } else if (featureId != 9) {
            return featureId;
        } else {
            Log.i("AppCompatDelegate", "You should now use the AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY id when requesting this feature.");
            return C0220R.styleable.Theme_switchStyle;
        }
    }
