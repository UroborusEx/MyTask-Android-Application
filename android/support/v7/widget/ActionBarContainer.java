...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0152R.styleable.ActionBar);
        this.mBackground = a.getDrawable(C0152R.styleable.ActionBar_background);
        this.mStackedBackground = a.getDrawable(C0152R.styleable.ActionBar_backgroundStacked);
        this.mHeight = a.getDimensionPixelSize(C0152R.styleable.ActionBar_height, -1);
        if (getId() == C0152R.id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = a.getDrawable(C0152R.styleable.ActionBar_backgroundSplit);
        }
        a.recycle();
        if (this.mIsSplit) {
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0152R.id.action_bar);
        this.mContextView = findViewById(C0152R.id.action_context_bar);
    }
    ...
    public void setTransitioning(boolean isTransitioning) {
        ...
        setDescendantFocusability(isTransitioning ? 393216 : AccessibilityNodeInfoCompat.ACTION_EXPAND);
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (this.mActionBarView == null && MeasureSpec.getMode(heightMeasureSpec) == LinearLayoutManager.INVALID_OFFSET && this.mHeight >= 0) {
            heightMeasureSpec = MeasureSpec.makeMeasureSpec(Math.min(this.mHeight, MeasureSpec.getSize(heightMeasureSpec)), LinearLayoutManager.INVALID_OFFSET);
        }
        ...
        if (this.mActionBarView != null) {
            ...
            if (this.mTabContainer != null && this.mTabContainer.getVisibility() != 8 && mode != 1073741824) {
                ...
                setMeasuredDimension(getMeasuredWidth(), Math.min(getMeasuredHeightWithMargins(this.mTabContainer) + topMarginForTabs, mode == LinearLayoutManager.INVALID_OFFSET ? MeasureSpec.getSize(heightMeasureSpec) : ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED));
            }
        }
    }
