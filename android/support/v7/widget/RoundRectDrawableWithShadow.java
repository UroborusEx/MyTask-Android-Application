...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, int backgroundColor, float radius, float shadowSize, float maxShadowSize) {
        ...
        this.mShadowStartColor = resources.getColor(C0153R.color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0153R.color.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C0153R.dimen.cardview_compat_inset_shadow);
