...
import com.snowmobile.tasks.BuildConfig;
...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C01864 implements OnFocusChangeListener {
        C01864() {
        }
    ...
    class C01875 implements OnLayoutChangeListener {
        C01875() {
        }
    ...
    class C01886 implements OnGlobalLayoutListener {
        C01886() {
        }
    ...
    class C01897 implements OnClickListener {
        C01897() {
        }
    ...
    class C01908 implements OnKeyListener {
        C01908() {
        }
    ...
    class C01919 implements OnEditorActionListener {
        C01919() {
        }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0152R.attr.autoCompleteTextViewStyle);
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0152R.attr.searchViewStyle);
    }

    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.mShowImeRunnable = new C01831();
        this.mUpdateDrawableStateRunnable = new C01842();
        this.mReleaseCursorRunnable = new C01853();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C01897();
        this.mTextKeyListener = new C01908();
        this.mOnEditorActionListener = new C01919();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0152R.styleable.SearchView, defStyleAttr, 0);
        this.mTintManager = a.getTintManager();
        LayoutInflater.from(context).inflate(a.getResourceId(C0152R.styleable.SearchView_layout, C0152R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0152R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0152R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0152R.id.search_plate);
        this.mSubmitArea = findViewById(C0152R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0152R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0152R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0152R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0152R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0152R.id.search_mag_icon);
        this.mSearchPlate.setBackgroundDrawable(a.getDrawable(C0152R.styleable.SearchView_queryBackground));
        this.mSubmitArea.setBackgroundDrawable(a.getDrawable(C0152R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0152R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0152R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0152R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0152R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0152R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0152R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(C0152R.styleable.SearchView_suggestionRowLayout, C0152R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0152R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C01864());
        setIconifiedByDefault(a.getBoolean(C0152R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0152R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0152R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0152R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0152R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0152R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0152R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C01875());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C01886());
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0152R.dimen.abc_search_view_preferred_width);
    }
    ...
    private boolean onSuggestionsKey(View v, int keyCode, KeyEvent event) {
        ...
        if (keyCode != 21 && keyCode != 22) {
            return (keyCode == 19 && this.mSearchSrcTextView.getListSelection() == 0) ? IS_AT_LEAST_FROYO : IS_AT_LEAST_FROYO;
        } else {
            int selPoint;
            if (keyCode == 21) {
                selPoint = 0;
    ...
    private void updateSearchAutoComplete() {
        ...
        if ((inputType & 15) == 1) {
            ...
            if (this.mSearchable.getSuggestAuthority() != null) {
                inputType = (inputType | AccessibilityNodeInfoCompat.ACTION_CUT) | AccessibilityNodeInfoCompat.ACTION_COLLAPSE;
            }
        }
        this.mSearchSrcTextView.setInputType(inputType);
    ...
    private void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0152R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0152R.dimen.abc_dropdownitem_text_padding_left) : 0;
