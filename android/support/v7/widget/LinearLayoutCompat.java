...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            this.gravity = -1;
            TypedArray a = c.obtainStyledAttributes(attrs, C0152R.styleable.LinearLayoutCompat_Layout);
            this.weight = a.getFloat(C0152R.styleable.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.gravity = a.getInt(C0152R.styleable.LinearLayoutCompat_Layout_android_layout_gravity, -1);
            a.recycle();
        }
    ...
    public LinearLayoutCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0152R.styleable.LinearLayoutCompat, defStyleAttr, SHOW_DIVIDER_NONE);
        int index = a.getInt(C0152R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (index >= 0) {
            setOrientation(index);
        }
        index = a.getInt(C0152R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (index >= 0) {
            setGravity(index);
        }
        boolean baselineAligned = a.getBoolean(C0152R.styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (!baselineAligned) {
            setBaselineAligned(baselineAligned);
        }
        this.mWeightSum = a.getFloat(C0152R.styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = a.getInt(C0152R.styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = a.getBoolean(C0152R.styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(a.getDrawable(C0152R.styleable.LinearLayoutCompat_divider));
        this.mShowDividers = a.getInt(C0152R.styleable.LinearLayoutCompat_showDividers, SHOW_DIVIDER_NONE);
        this.mDividerPadding = a.getDimensionPixelSize(C0152R.styleable.LinearLayoutCompat_dividerPadding, SHOW_DIVIDER_NONE);
        a.recycle();
    }
    ...
    void measureVertical(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int largestChildHeight = LinearLayoutManager.INVALID_OFFSET;
        int i = SHOW_DIVIDER_NONE;
        while (i < count) {
            LayoutParams lp;
            int totalLength;
            ...
            if (child == null) {
                ...
                if (heightMode == 1073741824 && lp.height == 0 && lp.weight > 0.0f) {
                    ...
                    int oldHeight = LinearLayoutManager.INVALID_OFFSET;
    ...
    void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int largestChildWidth = LinearLayoutManager.INVALID_OFFSET;
        int i = SHOW_DIVIDER_NONE;
        while (i < count) {
            int childWidth;
            ...
            if (child == null) {
                ...
                if (widthMode == 1073741824 && lp.width == 0 && lp.weight > 0.0f) {
                    ...
                    int oldWidth = LinearLayoutManager.INVALID_OFFSET;
                ...
                if (baselineAligned) {
                    ...
                    if (childBaseline != -1) {
                        ...
                        int index = (((i2 & 112) >> VERTICAL_GRAVITY_COUNT) & -2) >> VERTICAL;
                ...
                if (!(child == null || child.getVisibility() == 8)) {
                    ...
                    if (baselineAligned) {
                        ...
                        if (childBaseline != -1) {
                            ...
                            index = (((i2 & 112) >> VERTICAL_GRAVITY_COUNT) & -2) >> VERTICAL;
                            maxAscent[index] = Math.max(maxAscent[index], childBaseline);
                            maxDescent[index] = Math.max(maxDescent[index], childHeight - childBaseline);
                        }
                    }
