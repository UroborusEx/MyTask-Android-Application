...
public class LinearLayoutManager extends LayoutManager implements ViewDropHandler {
    ...
    public static class SavedState implements Parcelable {
        ...
        static class C01751 implements Creator<SavedState> {
            C01751() {
            }
    ...
    class C03231 extends LinearSmoothScroller {
        C03231(Context x0) {
            super(x0);
        }
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, State state, int position) {
        LinearSmoothScroller linearSmoothScroller = new C03231(recyclerView.getContext());
    ...
    private int convertFocusDirectionToLayoutDirection(int focusDirection) {
        ...
        switch (focusDirection) {
            ...
            case TimePickerDialog.AMPM_INDEX /*2*/:
                return VERTICAL;
            case C0220R.styleable.Toolbar_maxButtonHeight /*17*/:
                if (this.mOrientation != 0) {
                    return INVALID_OFFSET;
                }
                return -1;
            case C0220R.styleable.Theme_actionModeCopyDrawable /*33*/:
                if (this.mOrientation != VERTICAL) {
                    return INVALID_OFFSET;
                }
                return -1;
