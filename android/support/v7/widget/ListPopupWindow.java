...
public class ListPopupWindow {
    ...
    class C01773 implements OnItemSelectedListener {
        C01773() {
        }
    ...
    class C02901 extends ForwardingListener {
        C02901(View x0) {
            super(x0);
        }
    ...
    private static class DropDownListView extends ListViewCompat {
        ...
        public DropDownListView(Context context, boolean hijackFocus) {
            super(context, null, C0152R.attr.dropDownListViewStyle);
    ...
    public ListPopupWindow(Context context) {
        this(context, null, C0152R.attr.listPopupWindowStyle);
    }

    public ListPopupWindow(Context context, AttributeSet attrs) {
        this(context, attrs, C0152R.attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0152R.styleable.ListPopupWindow, defStyleAttr, defStyleRes);
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0152R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, POSITION_PROMPT_ABOVE);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0152R.styleable.ListPopupWindow_android_dropDownVerticalOffset, POSITION_PROMPT_ABOVE);
        ...
        if (isShowing() && keyCode != 62 && (this.mDropDownList.getSelectedItemPosition() >= 0 || !isConfirmKey(keyCode))) {
            ...
            if (!(below && keyCode == 19 && curIndex <= firstItem) && (below || keyCode != 20 || curIndex < lastItem)) {
                ...
                if (this.mDropDownList.onKeyDown(keyCode, event)) {
                    ...
                    show();
                    switch (keyCode) {
                        case C0220R.styleable.Toolbar_collapseContentDescription /*19*/:
                        case C0220R.styleable.Toolbar_navigationIcon /*20*/:
                        case C0220R.styleable.Toolbar_titleTextColor /*23*/:
                        case C0220R.styleable.Theme_textAppearanceSearchResultSubtitle /*66*/:
                            return true;
                    }
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C01762();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C01773());
