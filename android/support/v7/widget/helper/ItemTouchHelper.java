...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    class C02024 implements Runnable {
        ...
        C02024(RecoverAnimation recoverAnimation, int i) {
    ...
    public static abstract class Callback {
        ...
        static class C02031 implements Interpolator {
            C02031() {
            }
        ...
        static class C02042 implements Interpolator {
            C02042() {
            }
        ...
        static {
            sDragScrollInterpolator = new C02031();
            sDragViewScrollCapInterpolator = new C02042();
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == ItemTouchHelper.ACTIVE_POINTER_ID_NONE) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0154R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
    ...
    class C02992 implements OnItemTouchListener {
        C02992() {
        }
    ...
    class C03005 implements ChildDrawingOrderCallback {
        C03005() {
        }
    ...
    private class RecoverAnimation implements AnimatorListenerCompat {
        ...
        class C03011 implements AnimatorUpdateListenerCompat {
            final /* synthetic */ ItemTouchHelper val$this$0;

            C03011(ItemTouchHelper itemTouchHelper) {
        ...
        public RecoverAnimation(ViewHolder viewHolder, int animationType, int actionState, float startDx, float startDy, float targetX, float targetY) {
            ...
            this.mValueAnimator.addUpdateListener(new C03011(ItemTouchHelper.this));
    ...
    class C03263 extends RecoverAnimation {
        final /* synthetic */ ViewHolder val$prevSelected;
        final /* synthetic */ int val$swipeDir;

        C03263(ViewHolder x0, int x1, int x2, float x3, float x4, float x5, float x6, int i, ViewHolder viewHolder) {
            this.val$swipeDir = i;
        ...
        if (selected != this.mSelected || actionState != this.mActionState) {
            ...
            if (this.mSelected != null) {
                ...
                if (prevSelected.itemView.getParent() != null) {
                    ...
                    RecoverAnimation rv = new C03263(prevSelected, animationType, prevActionState, currentTranslateX, currentTranslateY, targetTranslateX, targetTranslateY, swipeDir, prevSelected);
    ...
    private void postDispatchSwipe(RecoverAnimation anim, int swipeDir) {
        this.mRecyclerView.post(new C02024(anim, swipeDir));
    }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C03005();
            }
