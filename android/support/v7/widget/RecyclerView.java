...
import android.support.v7.recyclerview.C0154R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    static class C01803 implements Interpolator {
        C01803() {
        }
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0154R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0154R.styleable.RecyclerView_android_orientation, RecyclerView.VERTICAL);
            properties.spanCount = a.getInt(C0154R.styleable.RecyclerView_spanCount, RecyclerView.VERTICAL);
            properties.reverseLayout = a.getBoolean(C0154R.styleable.RecyclerView_reverseLayout, RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST);
            properties.stackFromEnd = a.getBoolean(C0154R.styleable.RecyclerView_stackFromEnd, RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST);
            a.recycle();
            return properties;
        }
    }
    ...
    class C02944 implements ProcessCallback {
        C02944() {
        }
    ...
    class C02955 implements Callback {
        C02955() {
        }
    ...
    class C02966 implements Callback {
        C02966() {
        }
    ...
    static {
        ...
        sQuinticInterpolator = new C01803();
    }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C01781();
        ...
        this.mItemAnimatorRunner = new C01792();
        this.mViewInfoProcessCallback = new C02944();
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0154R.styleable.RecyclerView, defStyle, TOUCH_SLOP_DEFAULT);
            String layoutManagerName = a.getString(C0154R.styleable.RecyclerView_layoutManager);
            a.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C02955());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C02966());
    }
