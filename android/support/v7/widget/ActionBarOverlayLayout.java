...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    class C03171 extends ViewPropertyAnimatorListenerAdapter {
        C03171() {
        }
    ...
    static {
        ATTRS = new int[]{C0152R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C03171();
        this.mRemoveActionBarHideOffset = new C01592();
        this.mAddActionBarHideOffset = new C01603();
        init(context);
    ...
    public void onWindowSystemUiVisibilityChanged(int visible) {
        ...
        if ((visible & AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY) != 0) {
            stable = true;
        } else {
            stable = false;
        }
        ...
        if ((diff & AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY) != 0 && this.mActionBarVisibilityCallback != null) {
            ViewCompat.requestApplyInsets(this);
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        boolean stable = (ViewCompat.getWindowSystemUiVisibility(this) & AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY) != 0;
        if (stable) {
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0152R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0152R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0152R.id.action_bar));
        }
    }
    ...
    private boolean shouldHideActionBarOnFling(float velocityX, float velocityY) {
        this.mFlingEstimator.fling(0, 0, 0, (int) velocityY, 0, 0, LinearLayoutManager.INVALID_OFFSET, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
