...
import android.support.v7.cardview.C0153R;
...
public class CardView extends FrameLayout implements CardViewDelegate {
    ...
    private void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = context.obtainStyledAttributes(attrs, C0153R.styleable.CardView, defStyleAttr, C0153R.style.CardView_Light);
        int backgroundColor = a.getColor(C0153R.styleable.CardView_cardBackgroundColor, 0);
        float radius = a.getDimension(C0153R.styleable.CardView_cardCornerRadius, 0.0f);
        float elevation = a.getDimension(C0153R.styleable.CardView_cardElevation, 0.0f);
        float maxElevation = a.getDimension(C0153R.styleable.CardView_cardMaxElevation, 0.0f);
        this.mCompatPadding = a.getBoolean(C0153R.styleable.CardView_cardUseCompatPadding, false);
        this.mPreventCornerOverlap = a.getBoolean(C0153R.styleable.CardView_cardPreventCornerOverlap, true);
        int defaultPadding = a.getDimensionPixelSize(C0153R.styleable.CardView_contentPadding, 0);
        this.mContentPadding.left = a.getDimensionPixelSize(C0153R.styleable.CardView_contentPaddingLeft, defaultPadding);
        this.mContentPadding.top = a.getDimensionPixelSize(C0153R.styleable.CardView_contentPaddingTop, defaultPadding);
        this.mContentPadding.right = a.getDimensionPixelSize(C0153R.styleable.CardView_contentPaddingRight, defaultPadding);
        this.mContentPadding.bottom = a.getDimensionPixelSize(C0153R.styleable.CardView_contentPaddingBottom, defaultPadding);
