...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    class C02871 extends ForwardingListener {
        final /* synthetic */ DropdownPopup val$popup;

        C02871(View x0, DropdownPopup dropdownPopup) {
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        class C01691 implements OnItemClickListener {
            final /* synthetic */ AppCompatSpinner val$this$0;

            C01691(AppCompatSpinner appCompatSpinner) {
        ...
        class C01702 implements OnGlobalLayoutListener {
            C01702() {
            }
        ...
        class C01713 implements OnDismissListener {
            final /* synthetic */ OnGlobalLayoutListener val$layoutListener;

            C01713(OnGlobalLayoutListener onGlobalLayoutListener) {
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            setOnItemClickListener(new C01691(AppCompatSpinner.this));
        }
        ...
        void computeContentWidth() {
            ...
            int hOffset = AppCompatSpinner.MODE_DIALOG;
            if (background != null) {
        ...
        public void show() {
            ...
            if (!wasShowing) {
                ViewTreeObserver vto = AppCompatSpinner.this.getViewTreeObserver();
                if (vto != null) {
                    OnGlobalLayoutListener layoutListener = new C01702();
                    vto.addOnGlobalLayoutListener(layoutListener);
                    setOnDismissListener(new C01713(layoutListener));
                }
            }
        }
    ...
    public AppCompatSpinner(Context context, int mode) {
        this(context, null, C0152R.attr.spinnerStyle, mode);
    }

    public AppCompatSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, C0152R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode, Theme popupTheme) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0152R.styleable.Spinner, defStyleAttr, MODE_DIALOG);
        ...
        if (popupTheme != null) {
            ...
            int popupThemeResId = a.getResourceId(C0152R.styleable.Spinner_popupTheme, MODE_DIALOG);
        ...
        if (this.mPopupContext != null) {
            if (mode == MODE_THEME) {
                if (VERSION.SDK_INT >= 11) {
                    TypedArray aa = null;
                    try {
                        aa = context.obtainStyledAttributes(attrs, ATTRS_ANDROID_SPINNERMODE, defStyleAttr, MODE_DIALOG);
                        if (aa.hasValue(MODE_DIALOG)) {
                            mode = aa.getInt(MODE_DIALOG, MODE_DIALOG);
                        }
                        if (aa != null) {
                            aa.recycle();
                        }
            ...
            if (mode == MODE_DROPDOWN) {
                DropdownPopup popup = new DropdownPopup(this.mPopupContext, attrs, defStyleAttr);
                TintTypedArray pa = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attrs, C0152R.styleable.Spinner, defStyleAttr, MODE_DIALOG);
                this.mDropDownWidth = pa.getLayoutDimension(C0152R.styleable.Spinner_android_dropDownWidth, -2);
                popup.setBackgroundDrawable(pa.getDrawable(C0152R.styleable.Spinner_android_popupBackground));
                popup.setPromptText(a.getString(C0152R.styleable.Spinner_android_prompt));
                pa.recycle();
                this.mPopup = popup;
                this.mForwardingListener = new C02871(this, popup);
            }
        }
        a.recycle();
        this.mPopupSet = true;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mPopup != null && MeasureSpec.getMode(widthMeasureSpec) == LinearLayoutManager.INVALID_OFFSET) {
    ...
    private int compatMeasureContentWidth(SpinnerAdapter adapter, Drawable background) {
        ...
        int widthMeasureSpec = MeasureSpec.makeMeasureSpec(getMeasuredWidth(), MODE_DIALOG);
        int heightMeasureSpec = MeasureSpec.makeMeasureSpec(getMeasuredHeight(), MODE_DIALOG);
