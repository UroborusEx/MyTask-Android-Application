...
public class MenuBuilder implements SupportMenu {
    ...
    L_0x0022:
        r4 = 0;
        r5.removeItemAtInt(r0, r4);
        r3 = r2;
        goto L_0x0010;
    L_0x0028:
        r4 = 1;
        r5.onItemsChanged(r4);
    L_0x002c:
        return;
        */
    ...
    private void setShortcutsVisibleInner(boolean shortcutsVisible) {
        boolean z = true;
        if (!(shortcutsVisible && this.mResources.getConfiguration().keyboard != 1 && this.mResources.getBoolean(C0152R.bool.abc_config_showMenuShortcutsWhenKeyboardPresent))) {
            z = false;
        }
