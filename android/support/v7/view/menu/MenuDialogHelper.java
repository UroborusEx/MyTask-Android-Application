...
class MenuDialogHelper implements OnKeyListener, OnClickListener, OnDismissListener, Callback {
    ...
    public void show(IBinder windowToken) {
        ...
        this.mPresenter = new ListMenuPresenter(builder.getContext(), C0152R.layout.abc_list_menu_item_layout);
        ...
        lp.flags |= AccessibilityNodeInfoCompat.ACTION_SET_SELECTION;
        this.mDialog.show();
    }
